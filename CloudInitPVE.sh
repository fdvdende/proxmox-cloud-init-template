...
# Orginal source: https://www.apalrd.net/posts/2023/pve_cloud/
...
function create_template() {
    ...
    qm set $1 --net0 virtio,bridge=vmbr0,tag=148,firewall=1
    ...
    qm set $1 --scsi0 ${storage}:0,import-from="$(pwd)/$3",discard=on,ssd=1,iothread=1
...
export ssh_keyfile=/root/keys.pub
#Username to create on VM template
export username=ferry
...
## Fedora 39
wget "https://download.fedoraproject.org/pub/fedora/linux/releases/39/Cloud/x86_64/images/Fedora-Cloud-Base-39-1.5.x86_64.raw.xz"
xz -d -v Fedora-Cloud-Base-39-1.5.x86_64.raw.xz
create_template 922 "temp-fedora-39" "Fedora-Cloud-Base-39-1.5.x86_64.raw"
...
create_template 940 "temp-Alma-8" "AlmaLinux-8-GenericCloud-latest.x86_64.qcow2"
#Alma 9 latest
wget "https://repo.almalinux.org/almalinux/9/cloud/x86_64/images/AlmaLinux-9-GenericCloud-latest.x86_64.qcow2"
create_template 941 "temp-Alma-9" "AlmaLinux-9-GenericCloud-latest.x86_64.qcow2"
